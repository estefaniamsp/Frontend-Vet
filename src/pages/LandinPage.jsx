                ...
                <section>
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-md py-5 leading-8 text-gray-800 md:text-xl max-w-lg mx-auto dark:text-white">
                            ...
                            elit. Vel vero dolore pariatur asperiores
                            voluptatibus sunt optio iste atque animi id odio
                            aliquid sapiente voluptatem, accusantium, ea sed
                            quibusdam a. Itaque.
                        </p>
                    </div>
                ...
                <section>
                    <div>
                        ...
                        <p className="text-md py-2 leading-8 text-gray-800 dark:text-white">
                            Lorem ipsum dolor, sit amet consectetur adipisicing
                            elit. Molestiae, delectus iure{" "}
                            <span className="text-teal-500">quibusdam</span>{" "}
                            quas quaerat itaque, est minima ducimus recusandae
                            illo ipsam numquam nam earum libero{" "}
                            <span className="text-teal-500">deleniti</span>{" "}
                            voluptatem! Autem, veniam ut.
                        </p>
                        <p className="text-md py-2 leading-8 text-gray-800 dark:text-white">
                            Lorem ipsum dolor, sit amet consectetur adipisicing
                            elit. Molestiae, delectus iure{" "}
                    ...
                    <div className="md:flex md:flex-wrap lg:flex lg:justify-center gap-10">
                        <div className="text-center shadow-2xl p-10 rounded-xl my-10 md:w-72 lg:w-96 dark:bg-slate-100">
                            ...
                            <p className="py-4 text-teal-600">
                                ...
                                adipisicing elit. Molestias repudiandae aliquid
                                dolores officiis neque. Voluptatem quod nemo,
                                totam iste atque id aspernatur porro laborum,
                                non quo, pariatur nobis natus consectetur?
                            </p>
